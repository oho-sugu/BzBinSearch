 ...
 * @NotThreadSafe
 */
public class BZip2PartedCompressorInputStream extends CompressorInputStream implements
                                                                          BZip2Constants {
    ...
    // Variables used by mode change
    private boolean serialMode = false;
    
    /**
     * All memory intensive stuff. This field is initialized by initBlock().
     */
    private BZip2PartedCompressorInputStream.Data data;
     ...
     *             if <tt>in == null</tt>
     */
    public BZip2PartedCompressorInputStream(final InputStream in,int bsBuff,int bsLive,int blockSize100k, boolean serialMode) throws IOException {
        super();
